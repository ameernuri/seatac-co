...
export const metadata: Metadata = buildSeatacMetadata({
 ...
 description:"Compare Sea-Tac parking inventory through ParkWhiz and connect it with airport, hotel, and ride planning.",
 path:"/parking",
});
...
export default async function ParkingPage({ searchParams }: ParkingPageProps) {
 ...
 <JsonLd
 data={buildCollectionPageJsonLd("Sea-Tac parking","Parking search and booking hub for Seattle-Tacoma International Airport travelers.","/parking",
 ...
 <input
 type="datetime-local"name="startsAt"defaultValue={startsAt}
 ...
 <input
 type="datetime-local"name="endsAt"defaultValue={endsAt}
 className="h-12 rounded-[1rem] border border-[#2d6a4f]/20 bg-white px-4 text-base text-[#1a3d34] outline-none transition focus:border-[#2d6a4f]/45"/>
 </label>
