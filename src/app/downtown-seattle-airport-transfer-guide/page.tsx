...
const pageDescription ="Use this downtown Seattle airport transfer guide to choose the right Sea-Tac route for downtown hotels, waterfront stays, cruise pre-stays, Pike Place, and return airport departures.";
const pagePath ="/downtown-seattle-airport-transfer-guide";

const downtownUseCases = [
 {
 title:"Downtown hotel arrivals",
 summary:"Best when the airport ride ends at a hotel in the central downtown core, Belltown, or near Pike Place. Start with the downtown route page, then use the hotel-specific pages if the stay needs more planning detail.",
 ...
 summary:"Use the downtown transfer cluster when the airport ride connects to waterfront hotels, Bell Street staging, or a Seattle cruise plan that still starts with a downtown overnight.",
 ...
 summary:"Downtown airport transfers also cover office towers, convention traffic, and return trips back to Sea-Tac. The better page is usually the downtown route unless the trip is really an arrivals/departures timing problem.",
...
const decisionPoints = [
 ...
 body:"Travelers often say “Seattle” when the trip is actually Bellevue, a cruise terminal, or an airport hotel. This page is meant for downtown hotel blocks, the waterfront core, office towers, and central Seattle arrivals.",
 },
 {
 title:"Use hotel pages when the stay changes the route logic",
 body:"If the airport transfer depends on a downtown luxury hotel, waterfront stay, or cruise-pre-stay pattern, the hotel support pages do a better job than a generic downtown route alone.",
 },
 {
 title:"Keep downtown transfer planning separate from cruise terminal planning",
 body:"A downtown hotel stay before a cruise is still different from the terminal transfer itself. Use this page to choose the downtown leg, then move into the Pier 66 or Pier 91 comparison if the next move is cruise-day transportation.",
 },
] as const;
...
const faqEntries = [
 ...
 answer:"Start with the Sea-Tac to downtown Seattle route page if the destination is a downtown hotel, office, or waterfront stay. Use the related hotel pages if the trip is really about a specific downtown lodging pattern or cruise-pre-stay decision.",
 },
 {
 question:"Should I use the downtown Seattle route page or the airport car service page?",
 answer:"Use the downtown route page when the drop-off is in downtown Seattle. Use the main airport car service page when you still need to choose between downtown, Bellevue, airport hotels, or another airport destination cluster.",
 },
 {
 question:"Does this guide help with waterfront and cruise pre-stay hotels?",
 answer:"Yes. Waterfront hotel stays and downtown cruise-pre-stay plans still belong in the downtown transfer cluster before you move into terminal-specific cruise transportation.",
 },
 {
 question:"Where should I go if the problem is timing, not destination?",
 answer:"Use the arrivals and departures guides when the main question is pickup timing, bag claim flow, or return-airport scheduling rather than which downtown destination cluster you need.",
 },
];
...
export default function DowntownSeattleAirportTransferGuidePage() {
 ...
 const collectionJsonLd = buildCollectionPageJsonLd("Downtown Seattle airport transfer guide",
 pageDescription,
 pagePath,
 ...
 <Link
 href="/seatac-to-downtown-seattle"className="rounded-full bg-emerald-700 px-6 py-3 text-sm font-semibold text-white transition hover:bg-emerald-800">
 View downtown route
 </Link>
 <Link
