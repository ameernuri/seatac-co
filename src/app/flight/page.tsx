...
const routeDetailHrefBySlug: Record<string, string> = {"seatac-downtown-core":"/seatac-to-downtown-seattle","seatac-bellevue-core":"/seatac-to-bellevue","seatac-kirkland-core":"/seatac-to-kirkland","seatac-pier-66":"/seatac-to-pier-66","seatac-pier-91":"/seatac-to-pier-91","seatac-airport-hotels-core":"/seatac-airport-hotels",
};
...
export default async function FlightPage({ searchParams }: FlightPageProps) {
 ...
 const routeCards: FlightRouteCard[] = ["seatac-downtown-core","seatac-bellevue-core","seatac-airport-hotels-core","seatac-pier-66","seatac-pier-91",
 ]
 ...
 .filter((hotel) =>
 ["coast-gateway-hotel","cedarbrook-lodge","grand-hyatt-seattle","hyatt-regency-bellevue",
 ].includes(hotel.slug),
 )
 .map((hotel) => {
 ...
 <h1 className="mt-4 text-[clamp(2.8rem,5vw,4.8rem)] leading-[0.92] text-[#1a3d34]">
 ...
 placeholder="DL117 or Alaska Airlines"className="h-14 rounded-[1.1rem] border border-[#2d6a4f]/20 bg-white px-4 text-base text-[#1a3d34] outline-none transition focus:border-[#2d6a4f]/45"/>
 </label>
 <div className="flex items-end">
 <button
 type="submit"className="inline-flex h-14 items-center justify-center rounded-[1.1rem] border border-[#2d6a4f]/20 bg-[#2d6a4f] px-6 text-sm font-semibold text-white shadow-[0_4px_16px_rgba(45,106,79,0.18)] transition hover:bg-[#24563f]">
 Search flight
 </button>
 </div>
 </form>
 ...
 <h2 className="mt-3 text-[2rem] leading-[1.02] text-[#1a3d34]">
 ...
 <div>
 <h3 className="text-[1.35rem] font-semibold text-[#123b33]">
 {card.name}
 </h3>
 ...
 <h2 className="mt-3 text-[1.8rem] leading-[1.04] text-[#1a3d34]">
