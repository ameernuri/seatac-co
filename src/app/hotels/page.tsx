...
export const metadata: Metadata = buildSeatacMetadata({
 ...
 description:"Search Seattle, SeaTac, Bellevue, and cruise-pre-stay hotels with Booking.com Demand rates and Expedia Rapid destination intelligence.",
 path:"/hotels",
});
...
export default async function HotelsPage({ searchParams }: HotelsPageProps) {
 ...
 <JsonLd
 data={buildCollectionPageJsonLd("Seattle and Sea-Tac hotels","Hotel booking and stay-planning hub for Sea-Tac travelers.","/hotels",
 ...
 <h1 className="mt-4 text-[clamp(2.8rem,5vw,4.9rem)] leading-[0.92] text-[#1a3d34]">
 ...
 <input
 type="text"name="destination"defaultValue={destination}
 ...
 <input
 type="date"name="checkin"defaultValue={checkin}
 className="h-12 rounded-[1rem] border border-[#2d6a4f]/20 bg-white px-4 text-base text-[#1a3d34] outline-none transition focus:border-[#2d6a4f]/45"/>
 </label>
 <label className="grid gap-2">
 <span className="text-[0.72rem] uppercase tracking-[0.22em] text-[#5a7a6e]">
 ...
 <input
 type="date"name="checkout"defaultValue={checkout}
 className="h-12 rounded-[1rem] border border-[#2d6a4f]/20 bg-white px-4 text-base text-[#1a3d34] outline-none transition focus:border-[#2d6a4f]/45"/>
 </label>
 <label className="grid gap-2">
 <span className="text-[0.72rem] uppercase tracking-[0.22em] text-[#5a7a6e]">Adults</span>
 <input
 type="number"name="adults"min="1"max="8"defaultValue={adults}
 className="h-12 rounded-[1rem] border border-[#2d6a4f]/20 bg-white px-4 text-base text-[#1a3d34] outline-none transition focus:border-[#2d6a4f]/45"/>
 </label>
 ...
 placeholder="Optional hotel name"className="h-12 rounded-[1rem] border border-[#2d6a4f]/20 bg-white px-4 text-base text-[#1a3d34] outline-none transition focus:border-[#2d6a4f]/45"/>
 </label>
 ...
 <div>
 <h3 className="text-[1.15rem] font-semibold text-[#123b33]">
 {offer.name}
 </h3>
 ...
 <h2 className="mt-3 text-[1.7rem] leading-[1.04] text-[#1a3d34]">
