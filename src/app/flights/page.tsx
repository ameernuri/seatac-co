...
export const metadata: Metadata = buildSeatacMetadata({
 ...
 description:"Search flights to and from Seattle-Tacoma International Airport with Skyscanner-powered discovery and Sea-Tac-specific planning links.",
 path:"/flights",
});
...
export default async function FlightsPage({ searchParams }: FlightsPageProps) {
 ...
 <JsonLd
 data={buildCollectionPageJsonLd("Sea-Tac flights","Flight shopping and Sea-Tac planning links for Seattle travelers.","/flights",
 ...
 <input
 type="text"name="origin"defaultValue={origin}
 ...
 placeholder="LAX"className="h-12 rounded-[1rem] border border-[#2d6a4f]/20 bg-white px-4 text-base text-[#1a3d34] outline-none transition focus:border-[#2d6a4f]/45"/>
 </label>
 <label className="grid gap-2">
 <span className="text-[0.72rem] uppercase tracking-[0.22em] text-[#5a7a6e]">
 Depart
 ...
 <input
 type="date"name="departDate"defaultValue={departDate}
 className="h-12 rounded-[1rem] border border-[#2d6a4f]/20 bg-white px-4 text-base text-[#1a3d34] outline-none transition focus:border-[#2d6a4f]/45"/>
 </label>
 <label className="grid gap-2">
 <span className="text-[0.72rem] uppercase tracking-[0.22em] text-[#5a7a6e]">
 ...
 <input
 type="date"name="returnDate"defaultValue={returnDate}
 className="h-12 rounded-[1rem] border border-[#2d6a4f]/20 bg-white px-4 text-base text-[#1a3d34] outline-none transition focus:border-[#2d6a4f]/45"/>
 </label>
 ...
 <input
 type="number"name="adults"min="1"max="9"defaultValue={adults}
 className="h-12 rounded-[1rem] border border-[#2d6a4f]/20 bg-white px-4 text-base text-[#1a3d34] outline-none transition focus:border-[#2d6a4f]/45"/>
 </label>
