...
export const metadata: Metadata = buildSeatacMetadata({
 ...
 description:"Track Seattle cruise arrivals and departures, then move directly into Sea-Tac rides, hotel stays, and terminal planning.",
 path:"/cruises",
});
...
export default async function CruisesPage() {
 ...
 <JsonLd
 data={buildCollectionPageJsonLd("Seattle cruises","Cruise terminal and sailing-planning hub for Seattle and Sea-Tac travelers.","/cruises",
