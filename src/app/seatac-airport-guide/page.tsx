...
const pageDescription ="Use the Sea-Tac airport guide to plan arrival timing, checkpoints, maps, ground transportation, light rail, hotel shuttles, and the next Seattle planning page to use.";
const pagePath ="/seatac-airport-guide";

const planningCards = [
 {
 title:"Checkpoint timing and airport arrival windows",
 summary:"SEA tells domestic travelers to arrive two hours before departure and international travelers three hours before departure. It also flags the busiest drive and checkpoint periods before 9 a.m., from 2 to 5 p.m., and from 9 to 11 p.m.",
 ...
 summary:"SEA publishes terminal maps, printable directories, and checkpoint details. One helpful rule: all gates are accessible from any checkpoint, so the best checkpoint is often the shortest one rather than the one closest to your airline sign.",
 ...
 summary:"Ride-share and taxis pick up on the third floor of the parking garage. Hotel courtesy shuttles use Islands 1 and 2 on that same level. Link light rail uses SeaTac/Airport Station, which connects to the terminal area by a pedestrian bridge.",
...
const decisionSteps = [
 ...
 body:"Use this page before booking when the traveler still needs to decide how early to arrive, where to meet a ride, whether a hotel shuttle makes sense, or which next planning page should guide the trip.",
 },
 {
 title:"Use the shortest checkpoint, not the nearest checkpoint",
 body:"SEA notes that all gates are reachable from any checkpoint. That changes the usual first-timer instinct: the best checkpoint is often the one with the better line, not the one nearest the airline counter.",
 },
 {
 title:"Separate airport orientation from the final destination decision",
 body:"After the airport basics are clear, move into the page that matches the real destination: airport hotels, downtown Seattle, Bellevue and the Eastside, cruise terminals, parking, arrivals, or departures.",
 },
] as const;
...
const faqEntries = [
 ...
 answer:"SEA says domestic travelers should arrive two hours before departure and international travelers should arrive three hours before departure. The airport also warns that drive and checkpoint demand is busiest before 9 a.m., from 2 to 5 p.m., and from 9 to 11 p.m.",
 },
 {
 question:"Do I need to use the checkpoint closest to my gate or airline?",
 answer:"No. SEA states that all gates are accessible from any checkpoint. Travelers should usually choose the checkpoint with the better line or screening option rather than the one that looks geographically closest to the airline counter.",
 },
 {
 question:"Where do ride-share, taxis, and hotel courtesy shuttles pick up at Sea-Tac?",
 answer:"Visit Seattle's transportation guide places taxis and ride-share on the third floor of the SEA parking garage. It also notes that hotel courtesy shuttles use Islands 1 and 2 on that same third-floor level.",
 },
 {
 question:"Is light rail directly connected to the airport?",
 answer:"Yes. Sound Transit says the pedestrian bridge at SeaTac/Airport Station is open 24 hours a day and gives pedestrian access from the lot, across the sky bridge, and into the terminal area.",
 },
 {
 question:"What should I do after I finish the airport basics?",
 answer:"Move into the page that matches the next decision: arrivals or departures timing, airport hotel planning, parking, downtown Seattle transfers, Bellevue and Eastside transfers, cruise transfers, or a specific airline guide.",
 },
];
...
export default function SeatacAirportGuidePage() {
 ...
 const collectionJsonLd = buildCollectionPageJsonLd("Sea-Tac airport guide",
 pageDescription,
 pagePath,
 ...
 <Link
 href="/departures"className="rounded-full bg-emerald-700 px-6 py-3 text-sm font-semibold text-white transition hover:bg-emerald-800">
 Start with departures
 </Link>
 <Link
 href="/seatac-airport-transfer-guide"className="rounded-full border border-emerald-200 bg-emerald-50 px-6 py-3 text-sm font-semibold text-emerald-800 transition hover:border-emerald-300 hover:bg-white">
 ...
 <Link
 href="/reserve"className="text-sm font-semibold text-emerald-800 transition hover:text-emerald-900">
