...
const pageDescription ="Get quick answers about Sea-Tac checkpoints, maps, rideshare pickup, hotel shuttles, light rail, and the next airport planning page to use.";
...
const faqEntries = [
 ...
 answer:"SEA recommends arriving two hours before domestic departures and three hours before international departures. The airport also warns that drive and checkpoint demand is busiest before 9 a.m., from 2 to 5 p.m., and from 9 to 11 p.m., so those windows usually need extra margin.",
 },
 {
 question:"Do I need to use the checkpoint closest to my gate?",
 answer:"No. SEA says all gates are accessible from any checkpoint. For most travelers, the practical choice is the checkpoint with the shorter line rather than the one that appears closest to the airline counter.",
 },
 {
 question:"Where do rideshare pickups, taxis, and hotel shuttles meet travelers at Sea-Tac?",
 answer:"Ground transportation options are centered on the third floor of the SEA parking garage. Visit Seattle's airport transportation guide places taxis, rideshare, and the Ground Transportation Plaza there, and it notes that hotel courtesy shuttles use Islands 1 and 2 on the same level.",
 },
 {
 question:"Is light rail directly connected to the airport?",
 answer:"Yes. Sound Transit says SeaTac/Airport Station connects to the terminal area by pedestrian bridge, which makes Link a useful downtown-oriented fallback after the airport basics are handled.",
 },
 {
 question:"Where can I find a Sea-Tac terminal map before the trip?",
 answer:"SEA publishes terminal maps, printable directories, and digital wayfinding resources on its maps page. That is the best starting point if you want the official layout before arriving.",
 },
 {
 question:"What page should I use after I finish the basic Sea-Tac questions?",
 answer:"Move into the page that matches the actual decision still left: departures timing, arrivals pickup, airport parking, hotel transfers, downtown Seattle transfers, Eastside transfers, cruise transfers, or an airline-specific guide.",
 },
 {
 question:"When is the Sea-Tac airport guide more useful than this FAQ page?",
 answer:"Use this FAQ page when you want quick answers fast. Use the broader Sea-Tac airport guide when you need fuller orientation, planning context, and a more complete set of next-step links.",
 },
];
...
export default function SeatacAirportFaqPage() {
 ...
 const collectionJsonLd = buildCollectionPageJsonLd("Sea-Tac airport FAQ",
 pageDescription,
 pagePath,
 ...
 <Link
 href="/seatac-airport-guide"className="rounded-full bg-emerald-700 px-6 py-3 text-sm font-semibold text-white transition hover:bg-emerald-800">
 Open the airport guide
 </Link>
 <Link
 href="/departures"className="rounded-full border border-emerald-200 bg-emerald-50 px-6 py-3 text-sm font-semibold text-emerald-800 transition hover:border-emerald-300 hover:bg-white">
 ...
 <h3 className="text-[1.15rem] font-semibold text-emerald-950">
 {faq.question}
 </h3>
