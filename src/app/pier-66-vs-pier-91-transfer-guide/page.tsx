...
const pageDescription ="Compare Pier 66 vs Pier 91 transfer planning from Sea-Tac, including terminal differences, hotel staging, luggage timing, and the right airport route for your Seattle cruise day.";
...
const terminalCards = [
 ...
 summary:"Pier 66 is the simpler fit when your cruise plan is tied to the downtown waterfront. It stays closer to Pike Place, Belltown, and Seattle hotel inventory that travelers often use before embarkation.",
 },
 {
 title:"Pier 91",
 ...
 summary:"Pier 91 is a different Seattle cruise terminal and should be planned as its own airport transfer. It is not interchangeable with Pier 66 and usually rewards tighter timing on embarkation morning.",
 },
] as const;
...
const planningSteps = [
 ...
 body:"Seattle cruise travelers often know the cruise line but not the terminal. The first step is to confirm whether your sailing uses Bell Street at Pier 66 or Smith Cove at Pier 91.",
 },
 {
 title:"Choose the route page that matches your actual embarkation point",
 body:"Once the terminal is confirmed, use the matching route page so the airport transfer opens with the correct terminal already selected instead of trying to explain it later in a generic booking flow.",
 },
 {
 title:"Plan the transfer together with the hotel and luggage decision",
 body:"Cruise transfer planning works better when the airport route, hotel stay, bag count, and sailing-day timing are treated as one decision instead of four separate ones.",
 },
] as const;
...
const faqEntries = [
 ...
 answer:"No. Pier 66 and Pier 91 are separate Seattle cruise terminals. Pier 66 is Bell Street Cruise Terminal on the downtown waterfront, while Pier 91 is Smith Cove Cruise Terminal farther northwest.",
 },
 {
 question:"How do I know which cruise terminal I need from Sea-Tac?",
 answer:"Check the terminal name on your cruise confirmation or use the terminal guide pages on seatac.co. The transfer should be booked to the exact terminal, not just to a generic “Seattle cruise terminal.”",
 },
 {
 question:"Should I choose a different hotel area for Pier 66 vs Pier 91?",
 answer:"Usually yes. Pier 66 works well with waterfront and downtown hotel stays, while Pier 91 often benefits from a simpler direct transfer plan or a hotel strategy that leaves more room for luggage and morning timing.",
 },
 {
 question:"Can I compare both terminals before booking a ride?",
 answer:"Yes. This comparison page is meant to help you decide whether your airport transfer should be planned around Bell Street at Pier 66 or Smith Cove at Pier 91 before you enter the booking flow.",
 },
];
...
export default function Pier66VsPier91TransferGuidePage() {
 ...
 const collectionJsonLd = buildCollectionPageJsonLd("Pier 66 vs Pier 91 transfer guide",
 pageDescription,
 pagePath,
 ...
 <Link
 href="/seatac-to-pier-66"className="rounded-full bg-emerald-700 px-6 py-3 text-sm font-semibold text-white transition hover:bg-emerald-800">
 View Pier 66 route
 </Link>
 <Link
 href="/seatac-to-pier-91"className="rounded-full border border-emerald-200 bg-emerald-50 px-6 py-3 text-sm font-semibold text-emerald-800 transition hover:border-emerald-300 hover:bg-white">
 View Pier 91 route
 </Link>
 </div>
 </div>
