...
export const metadata: Metadata = {
 ...
 description:"Airline-specific Sea-Tac guides with concourse notes, pickup timing, and direct links into airport routes and hotel pages.",
 path:"/airlines",
 }),
};
...
export default function AirlinesIndexPage() {
 ...
 <JsonLd
 data={buildCollectionPageJsonLd("Sea-Tac airline guides","Airline-specific Sea-Tac guides with concourse notes, pickup timing, and airport transfer links.","/airlines",
 ...
 <h2 className="text-[1.5rem] leading-[1.08] text-[#123b33]">
 {airline.name}
 </h2>
