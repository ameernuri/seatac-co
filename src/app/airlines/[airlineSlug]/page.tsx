...
export default async function AirlineGuidePage({ params }: AirlineGuidePageProps) {
 ...
 <h2 className="text-[1.3rem] font-semibold text-[#123b33]">
 Typical concourse
 </h2>
 ...
 <h3 className="text-[1.25rem] font-semibold text-[#123b33]">
 {route.name}
 </h3>
 ...
 key={link.href}
 href={link.href}
 className="rounded-[1.4rem] border border-[#2d6a4f]/10 bg-[#f8f7f4] px-5 py-5 text-sm font-semibold text-[#123b33] transition hover:border-[#2d6a4f]/20 hover:bg-white"rel="noreferrer"target="_blank">
 {link.label}
 </a>
 ))}
 </div>
