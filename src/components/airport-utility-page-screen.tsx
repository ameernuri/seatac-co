...
const routeDetailHrefBySlug: Record<string, string> = {"seatac-downtown-core":"/seatac-to-downtown-seattle","seatac-bellevue-core":"/seatac-to-bellevue","seatac-kirkland-core":"/seatac-to-kirkland","seatac-pier-66":"/seatac-to-pier-66","seatac-pier-91":"/seatac-to-pier-91","downtown-seatac-core":"/seatac-to-downtown-seattle-hotels","bellevue-seatac-core":"/seatac-to-bellevue-hotels","kirkland-seatac-core":"/seatac-to-kirkland","pier-66-seatac":"/seatac-to-pier-66","pier-91-seatac":"/seatac-to-pier-91",
};
...
export async function AirportUtilityPageScreen({
 ...
 <p className="mt-3 text-[1.8rem] font-semibold text-[#123b33]">
 {item.value}
 </p>
 </article>
 ))}
 ...
 <h2 className="text-[1.25rem] font-semibold text-[#123b33]">
 {item.title}
 </h2>
 ...
 key={faq.question}
 className="rounded-[1.5rem] border border-[#2d6a4f]/10 bg-[#f8f7f4] p-5">
 <h2 className="text-[1.1rem] font-semibold text-[#123b33]">
 {faq.question}
 </h2>
 ...
 <div>
 <h3 className="text-[1.3rem] font-semibold text-[#123b33]">
 {card.name}
 </h3>
