...
export async function CruiseTerminalPageScreen({
 ...
 <p className="mt-3 text-lg font-semibold text-[#123b33]">
 {item.value}
 </p>
 </article>
 ))}
 ...
 <h2 className="text-[1.2rem] font-semibold text-[#123b33]">
 {item.title}
 </h2>
 ...
 <h3 className="text-[1.2rem] font-semibold text-[#123b33]">
 {card.name}
 </h3>
